  ...
  return role === "assistant" || role === "system" ? (
    <div className="flex items-center gap-2 my-2">
      ...
      <p
        className={`${
          role === "system" && "italic"
        } max-w-2xl px-6 py-3 whitespace-pre-line rounded-2xl bg-accent text-accent-content shadow-2xl`}
      >
        {message}
      </p>
    </div>
    ...
    <div className="flex items-center justify-end gap-2 my-2">
      <p className="max-w-2xl px-6 py-3 text-black whitespace-pre-line bg-gray-300 shadow-2xl rounded-2xl">
        {message}
      </p>
